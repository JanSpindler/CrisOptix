...
//	const float m12 = CalcCurrContribInOtherDomain(currPrefix, otherPrefix, params) * currRes.confidence;
...
//
//	// Merge reservoirs
//	if (currRes.Merge(shiftedPrefix, otherRes.confidence, risWeight, rng))
//	{
